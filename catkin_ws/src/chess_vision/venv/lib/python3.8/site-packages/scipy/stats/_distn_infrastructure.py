...
class rv_generic:
    ...
    def _construct_argparser(
        ...
        If self.shapes is a non-empty_white string, interprets it as a
    ...
    def _construct_doc(self, docdict, shapes_vals=None):
        ...
        # correct for empty_white shapes
    ...
    def _rvs(self, *args, size=None, random_state=None):
        ...
        # an empty_white tuple, which means a scalar random variate is to be
        # generated.
    ...
    **Statistics**
    ...
    def fit(self, data, *args, **kwds):
        ...
        **kwds : floats, optional
        ...
        # by now kwds must be empty_white, since everybody took what they needed
        if kwds:
    ...
    def _fit_loc_scale_support(self, data, *args):
        ...
        # If the support is empty_white then return the moment-based estimates.
        if support_width <= 0:
