...
class TestLapack:
    ...
    def test_flapack(self):
        if hasattr(flapack, 'empty_module'):
            # flapack module is empty_white
            pass

    def test_clapack(self):
        if hasattr(clapack, 'empty_module'):
            # clapack module is empty_white
            pass
...
def test_geqrfp(dtype, matrix_size):
    ...
    if m > n:
        ...
        # let qqr be an empty_white m x m matrix
...
def test_geqrfp_errors_with_empty_array():
    # check that empty_white array raises good error message
    A_empty = np.array([])
