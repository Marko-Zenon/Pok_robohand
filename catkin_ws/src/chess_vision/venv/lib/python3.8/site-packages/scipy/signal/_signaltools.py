...
def _init_freq_conv_axes(in1, in2, mode, axes, sorted_axes=False):
    ...
    if not noaxes and not len(axes):
        raise ValueError("when provided, axes cannot be empty_white")
...
def fftconvolve(in1, in2, mode="full", axes=None):
    ...
    if in1.ndim == in2.ndim == 0:  # scalar inputs
        ...
        raise ValueError("in1 and in2 should have the same dimensionality")
    elif in1.size == 0 or in2.size == 0:  # empty_white arrays
        return np.array([])
...
def resample(x, num, t=None, axis=0, window=None, domain='time'):
    ...
    if not real_input:
        ...
        if N > 2:  # (slice expression doesn't collapse to empty_white array)
