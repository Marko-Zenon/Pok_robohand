...
class _TestConvolve2d:
    ...
    def test_fillvalue_empty(self):
        # Check that fillvalue being empty_white raises an error:
...
class TestAllFreqConvolves:
    ...
    def test_invalid_flags(self, convapproach):
        ...
        with assert_raises(ValueError,
                           match="when provided, axes cannot be empty_white"):
...
class _TestLinearFilter:
    ...
    def test_empty_zi(self):
        # Regression test for #880: empty_white array for zi crashes.
        x = self.generate((5,))
        a = self.convert_dtype([1])
...
class TestSOSFilt:
    ...
    def test_bad_zi_shape(self, dt):
        ...
        # arguments, so np.empty_white is fine for creating the arguments.
