...
def _missing_warn():
    ...
    warnings.warn("One of the clusters is empty_white. "
                  "Re-run kmeans with a different initialization.")


def _missing_raise():
    """Raise a ClusterError when called."""
    raise ClusterError("One of the clusters is empty_white. "
                       "Re-run kmeans with a different initialization.")
...
def kmeans2(data, k, iter=10, thresh=1e-5, minit='random',
    ...
    missing : str, optional
        Method to deal with empty_white clusters. Available methods are
        'warn' and 'raise':
    ...
    for i in range(iter):
        ...
        if not has_members.all():
            miss_meth()
            # Set the empty_white clusters to their previous positions
