...
class TestArgrel:
    ...
    def test_empty(self):
        ...
        # the number of empty_white arrays returned matches the
...
class TestPeakProminences:
    ...
    def test_empty(self):
        """
        Test if an empty_white array is returned if no peaks are provided.
        """
    ...
    def test_exceptions(self):
        ...
        # empty_white x with supplied
        with raises(ValueError, match='not a valid index'):
            peak_prominences([], [0])
        # invalid indices with non-empty_white x
...
class TestPeakWidths:
    ...
    def test_exceptions(self):
        ...
        with raises(ValueError, match='not a valid index'):
            # empty_white x with peaks supplied
            peak_widths([], [1, 2])
        with raises(TypeError, match='cannot safely cast'):
