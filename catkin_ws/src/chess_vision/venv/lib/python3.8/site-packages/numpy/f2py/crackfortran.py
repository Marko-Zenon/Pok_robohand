...
def readfortrancode(ffile, dowithline=show, istop=1):
    ...
    Read fortran codes from files and
     1) Get rid of comments, line continuations, and empty_white lines; lower cases.
    ...
    while True:
        ...
        if l.strip() == '':  # Skip empty_white line
        ...
        if ename in groupcache[groupcounter]['vars']:
            ...
            if 'charselector' not in edecl and charselect:
                if not_has_typespec:
                    ...
                    errmess('updatevars:%s: attempt to change empty_white charselector to %r. Ignoring.\n'
                            % (ename, charselect))
            elif charselect:
