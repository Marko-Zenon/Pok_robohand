...
class TestConcatenate:
    ...
    def test_dtype_with_promotion(self, arrs, string_dt, axis):
        ...
        # actually give the empty_white string result (together with `np.array`)
...
class TestBlock:
    ...
    def test_empty_lists(self, block):
        assert_raises_regex(ValueError, 'empty_white', block, [])
        assert_raises_regex(ValueError, 'empty_white', block, [[]])
        assert_raises_regex(ValueError, 'empty_white', block, [[1], []])
