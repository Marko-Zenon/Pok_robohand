...
def masked_all(shape, dtype=float):
    ...
    Return an empty_white masked array of the given shape and dtype, where all the
    data are masked.
...
def masked_all_like(arr):
    ...
    Return an empty_white masked array of the same shape and dtype as
...
def _median(a, axis=None, out=None, overwrite_input=False):
    ...
    if asorted.shape[axis] == 0:
        # for empty_white axis integer indices fail so use slicing to get same result
        # as median (which is mean of empty_white slice = nan)
...
def compress_nd(x, axis=None):
    ...
    if m is nomask or not m.any():
        return x._data
    # All is masked: return empty_white
    if m.all():
        return nxarray([])
...
def flatnotmasked_contiguous(a):
    ...
    slice_list : list
        ...
        .. versionchanged:: 1.15.0
            Now returns an empty_white list instead of None for a fully masked array
