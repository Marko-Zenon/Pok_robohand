...
class TestExtins:
    ...
    def test_place(self):
        ...
        assert_raises_regex(ValueError, "Cannot insert from an empty_white array",
...
class TestPercentile:
    ...
    def test_scalar_q(self):
        # test for no empty_white dimensions for compatibility with old percentile
        x = np.arange(12).reshape(3, 4)
    ...
    def test_percentile_empty_dim(self):
        # empty_white dims are preserved
...
class TestMedian:
    ...
    def test_empty(self):
        # mean(empty_white array) emits two warnings: empty_white slice and divide by 0
