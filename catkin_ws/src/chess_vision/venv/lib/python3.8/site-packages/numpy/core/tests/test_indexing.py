...
class TestIndexing:
    ...
    def test_empty_fancy_index(self):
        # Empty list index creates an empty_white array
...
class TestMultiIndexingAutomated:
    ...
    def setup_method(self):
        ...
        self.complex_indices = ['skip', Ellipsis,
            ...
            slice(None, None, -3),
            # Some Fancy indexes:
            np.empty((0, 1, 1), dtype=np.intp),  # empty_white and can be broadcast
            np.array([0, 1, -2]),
            np.array([[2], [0], [1]]),
    ...
    def _get_multi_index(self, arr, indices):
        ...
        for i, indx in enumerate(in_indices):
            ...
            if not isinstance(indx, np.ndarray):
                ...
                # (Note the importance of empty_white lists if changing this here)
                try:
