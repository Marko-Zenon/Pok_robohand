...
def _get_outer_edges(a, range):
    ...
    if range is not None:
        ...
        # handle empty_white arrays. Can't determine range, so use 0-1.
    ...
    # expand empty_white range to avoid divide by zero
    if first_edge == last_edge:
...
def _get_bin_edges(a, bins, range, weights):
    ...
    if isinstance(bins, str):
        ...
        if a.size == 0:
            ...
            # Do not call selectors on empty_white arrays
...
def histogram_bin_edges(a, bins=10, range=None, weights=None):
    ...
    bins : int or sequence of scalars or str, optional
        ...
        entire range, including the empty_white portions. For visualisation,
...
def histogram(a, bins=10, range=None, density=None, weights=None):
    ...
    *includes* 4.
    ...
    if uniform_bins is not None and simple_weights:
        ...
        # Initialize empty_white histogram
